    ...
    describe('The Controller', function () {
        ...
        describe('ctrl.createViewElementsLabel()', function () {
            ...
            it('should display the initial message if the elements are an empty array', function () {
                expect(ctrl.createViewElementsLabel([], 'entity types')).toEqual('Only include these entity types');
            });
            ...
            it('should throw an exception if the elements and elementType are undefined', function () {
                expect(function () {
                    ctrl.createViewElementsLabel(undefined, undefined)
                }).toThrow('Cannot create label without either the elements or element type')
            });
        });
