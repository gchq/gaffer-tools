...
if [ "$#" -lt 2 ]; then
	echo "Missing arguments: $0 <accumuloVersion> <outputDirectory> [--build-native]" >&2
	exit 1
fi
...
git clone -b branches/branch-0.91 --depth 1 https://github.com/apache/incubator-slider.git $TEMP_DIR
