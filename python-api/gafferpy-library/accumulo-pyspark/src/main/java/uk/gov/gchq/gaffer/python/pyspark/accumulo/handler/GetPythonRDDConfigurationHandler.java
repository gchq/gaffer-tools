...
/**
 * Gets a Hadoop conf from a Gaffer Accumulo store
 */
...
public class GetPythonRDDConfigurationHandler extends AbstractGetRDDHandler<GetPythonRDDConfiguration, Configuration> {
    ...
    private Configuration doOperation(final GetPythonRDDConfiguration operation,
    ...
    private Configuration doOperationUsingElementInputFormat(final GetPythonRDDConfiguration operation,
                                                            final Context context,
                                                            final AccumuloStore accumuloStore)
            throws OperationException {
