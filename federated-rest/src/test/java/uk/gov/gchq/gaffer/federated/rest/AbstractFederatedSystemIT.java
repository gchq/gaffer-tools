...
import uk.gov.gchq.gaffer.federated.rest.util.FederatedSystemTestUtil;
...
import static uk.gov.gchq.gaffer.federated.rest.util.FederatedSystemTestUtil.startFederatedServer;
import static uk.gov.gchq.gaffer.federated.rest.util.FederatedSystemTestUtil.stopServer;
...
public class AbstractFederatedSystemIT {
    ...
    public ExternalResource externalResource = new ExternalResource() {
        protected void before() throws Throwable {
            FederatedSystemTestUtil.reinitialiseGraph(testFolder, schemaResourcePath, storePropertiesResourcePath);
            services.forEach(FederatedSystemTestUtil::startServer);
        }
    ...
    public static void afterClass() {
        FederatedSystemTestUtil.stopFederatedServer();
    }
