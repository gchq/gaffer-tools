...
import uk.gov.gchq.gaffer.federated.rest.util.FederatedSystemTestStatusUtil;
...
public class SystemStatusServiceIT extends AbstractFederatedSystemIT {
    ...
    public void shouldReturnFederatedSystemStatus() {
        // When
        final Response response = FederatedSystemTestStatusUtil.getStatus();
    ...
    public void shouldReturnChildStatuses() {
        // When
        final Response response = FederatedSystemTestStatusUtil.getStatuses();

        // Then
        final List<FederatedSystemStatus> statusList = response.readEntity(new GenericType<List<FederatedSystemStatus>>() {
        });
