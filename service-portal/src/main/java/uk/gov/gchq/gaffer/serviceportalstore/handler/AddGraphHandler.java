...
public abstract class AddGraphHandler implements OperationHandler<AddGraph> {
    @Override
    public Object doOperation(final AddGraph operation, final Context context, final Store store) throws OperationException {
        Object futureEndpoint = processCreatingAGraph();
    ...
    protected void processGraphEntity(final ArrayList<Element> elements, final String graphId, final boolean isPublic) {
        /*
    ...
    protected abstract Object processCreatingAGraph();

    protected void processCanAccessEdge(final ArrayList<Element> elements, final String graphId, final Set<String> graphAuths) {
        /*
         * this is tightly coupled with the graphOfGraph schema
         */
